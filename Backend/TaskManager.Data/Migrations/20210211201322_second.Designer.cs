...
namespace TaskManager.Data.Migrations
{
    ...
    [Migration("20210211201322_second")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TaskFolderToDoTask", b =>
                {
                    ...
                    b.HasKey("FoldersId", "ToDoTasksId");
            ...
            modelBuilder.Entity("TaskFolderToDoTask", b =>
                {
                    b.HasOne("TaskManager.Domain.Models.TaskFolder", null)
                        .WithMany()
                        .HasForeignKey("FoldersId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("TaskManager.Domain.Models.ToDoTask", null)
                        .WithMany()
            ...
            modelBuilder.Entity("TaskManager.Domain.Models.TaskFolder", b =>
                {
                    ...
                    b.HasOne("TaskManager.Domain.Models.TaskFolder", "ParentFolder")
                        .WithMany("Folders")
